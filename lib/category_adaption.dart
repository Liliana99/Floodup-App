...
class Category_adaption extends StatefulWidget {
  @override
  _CategoryAdaptionState createState() => _CategoryAdaptionState();
}

class _CategoryAdaptionState extends State<Category_adaption> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/category_adaption.png'),
                          fit: BoxFit.cover
                      )
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(height: 20),
                      Text(
                        AppLocalizations.of(context).translate('category_adaptation_desc'),
                        style: TextStyle(
