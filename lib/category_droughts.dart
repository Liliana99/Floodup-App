...
class Category_droughts extends StatefulWidget {
  @override
  _CategoryDroughtState createState() => _CategoryDroughtState();
}

class _CategoryDroughtState extends State<Category_droughts> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/category_drought.png'),
                          fit: BoxFit.cover
                      )
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(height: 20),
                      Text(
                        AppLocalizations.of(context).translate('category_droughts_desc'),
                        style: TextStyle(
