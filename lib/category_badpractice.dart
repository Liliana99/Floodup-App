...
class Category_badpractice extends StatefulWidget {
  @override
  _CategoryBadpracticeState createState() => _CategoryBadpracticeState();
}

class _CategoryBadpracticeState extends State<Category_badpractice> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/category_badpractice.png'),
                          fit: BoxFit.cover
                      )
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(height: 20),
                      Text(
                        AppLocalizations.of(context).translate('category_badpractice_desc'),
                        style: TextStyle(
