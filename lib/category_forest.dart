...
class Category_forest extends StatefulWidget {
  @override
  _CategoryForestState createState() => _CategoryForestState();
}

class _CategoryForestState extends State<Category_forest> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/category_forestfire.png'),
                          fit: BoxFit.cover
                      )
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(height: 20),
                      Text(
                        AppLocalizations.of(context).translate('category_forestfire_desc'),
                        style: TextStyle(
